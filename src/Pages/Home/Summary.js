...
const Summary = () => {
    return (
        <div className='text-center my-32'>
            <div className="stats bg-gray-200 w-4/5">
                ...
                <div className="stat">
                    ...
                    <div className="stat-title text-primary">Delivered Parts</div>
                    <div className="stat-value text-primary">3K</div>
                    <div className="stat-desc text-primary">Apr 1st - May 1st</div>
                </div>
                ...
                <div className="stat">
                    ...
                    <div className="stat-title text-primary">Total Client</div>
                    <div className="stat-value text-primary">46</div>
                ...
                <div className="stat">
                    ...
                    <div className="stat-title text-primary">New Order</div>
